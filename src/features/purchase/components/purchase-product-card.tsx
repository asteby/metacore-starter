...
import type { PurchaseProduct } from '@/features/purchase/api/purchase-api'
...
export function PurchaseProductCard({ product, onClick }: PurchaseProductCardProps) {
  return (
    <Card
      className={cn(
        'cursor-pointer gap-0 overflow-hidden p-0 transition-all duration-200',
